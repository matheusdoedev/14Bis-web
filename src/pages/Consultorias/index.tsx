  ...
  return (
    <>
      <PaginaInterna title="Consultorias">
        ...
        <p>
          Com ela, é possível reduzir custos, tornar processos mais eficientes,
          otimizar as finanças, eficientes, otimizar as finanças, planejar
          expansões do negócio e aprimorar o trabalho do setor de recursos
          humanos, entre outras abordagens.
        </p>
