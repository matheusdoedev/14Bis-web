    ...
    <>
      <PaginaInterna title="Investimento">
        ...
        <p>
          ...
          empreendedores. Esse dinheiro pode impulsionar um negócio, ajudando no
          seu crescimento e sucesso. Existem vários tipos de investimentos, cada
          um para uma etapa específica do desenvolvimento de uma empresa. Veja
          quais são eles:
        </p>
