  ...
  return (
    <PerfilContainer>
      ...
      <Container>
        ...
        <Menu
          options={[
            { path: "/startups/0/editar-dados", label: "Dados Pessoais" },
            { path: "/startups/0/estatisticas", label: "Estatística" },
            { path: "/startups/0/notificacoes", label: "Notificações" },
            { path: "/startups/termos-de-uso", label: "Termos de uso" },
          ]}
        />
